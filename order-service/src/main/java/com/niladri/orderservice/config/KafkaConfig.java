...
import com.niladri.orderservice.error.NonRetryable;
import com.niladri.orderservice.error.Retryable;
...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic createInventoryUnavailableDltTopic() {
        return TopicBuilder.name(Topics.INVENTORY_UNAVAILABLE + "-dlt")
                .partitions(3)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
