        ...
        class CreateProduct {
                ...
                void createProduct_validRequest_returns201() throws Exception {
                        ...
                        mockMvc.perform(post(BASE_URL)
                                        ...
                                        .andExpect(jsonPath("$.data.originalPrice").value(149.99))
                ...
                void createProduct_nullPrice_returns400() throws Exception {
                        validRequest.setOriginalPrice(null);
                ...
                void createProduct_negativePrice_returns400() throws Exception {
                        validRequest.setOriginalPrice(new BigDecimal("-1.00"));
        ...
        class GetAllProducts {
                ...
                void getAllProducts_productsExist_returns200WithList() throws Exception {
                        ProductResponse second = ProductResponse.builder()
                                        ...
                                        .originalPrice(new BigDecimal("299.99")).currentPrice(new BigDecimal("299.99"))
                                        .stockQuantity(20).categoryName("Electronics").build();
        ...
        class UpdateProduct {
                ...
                void updateProduct_existingId_returns200() throws Exception {
                        ProductResponse updated = ProductResponse.builder()
                                        .id("1").name("Gaming Headset")
                                        .originalPrice(new BigDecimal("199.99")).currentPrice(new BigDecimal("199.99"))
                                        .stockQuantity(30).categoryName("Gaming").build();

                        when(productService.updateProduct(eq("1"), any(ProductRequest.class))).thenReturn(updated);
                        ...
                        mockMvc.perform(put(BASE_URL + "/1")
                                        ...
                                        .andExpect(jsonPath("$.data.originalPrice").value(199.99));
                }
                ...
                void updateProduct_nonExistingId_returns404() throws Exception {
                        when(productService.updateProduct(eq("99"), any(ProductRequest.class)))
                                        .thenThrow(new ProductNotFoundException("Product not found with id: 99"));
